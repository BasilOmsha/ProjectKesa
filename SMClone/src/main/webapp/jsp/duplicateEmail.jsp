...
<!-- End Google Tag Manager (noscript) -->
	...
	<div class="main">
		<form class="sign-up-form" id="myForm" action='../client' method='post'>
			...
			<div class="signup-input-container">
				...
				<input type="email" style="border: 1px solid #e83038;" name="email" placeholder="Use a different email address" id="all1" required />
			...
			<div id="birthday-info-text-positioning">
				<div id="birthday-info-container">
					...
					please visit our <a class="fine-prin-hover" href="#"
						style="color: blue">Data Policy.</a>
				</div>
			</div>
			...
			<div class="gender-container">
				<div class="all_gender">
					<label class="gender-lable" for="female">Female</label> <input
						class="gender-radio" type="radio" name="gender" id ="female" value="female" required onclick="expand()"/>
				</div>
				<div class="all_gender">
					<label class="gender-lable" for="female">Male<b
						style="color: #ffffff;">ss</b></label> <input class="gender-radio"
						type="radio" name="gender" id ="male" value="male" required onclick="expand()"/>
				</div>
				<div class="all_gender">
					<label class="gender-lable" for="other">Custom</label> <input
						class="gender-radio" type="radio" name="gender" id ="other" value="other" required onclick="expand()" />
				</div>
			</div>
			...
			<p class="fine-print">
				...
				information to ChatNook. <a class="fine-prin-hover" href="#"
					style="color: #385898">Learn more.</a>
			</p>
			<br>
			<p class="fine-print">
				By clicking Sign Up, you agree to our <a class="fine-prin-hover" style="color: #385898" href="#">Terms</a>. Learn
				how we collect, use and share your data in our <a class="fine-prin-hover" style="color: #385898" href="#">Data
					Policy</a> and how we use cookies and similar technology in our <a
					class="fine-prin-hover" style="color: #385898" href="#" >Cookies
					Policy</a>. You may receive SMS Notifications from us and can opt out
				any time.
			</p>
