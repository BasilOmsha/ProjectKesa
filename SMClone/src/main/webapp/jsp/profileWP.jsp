...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-WSH8LZJZX4"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-WSH8LZJZX4');
</script>
<%
	...
	<main>
		<div class="profile-upper-block">
			...
			<div class="alert success">
				<span class="closebtn">&times;</span> <strong>Wrong
					password!</strong> Check your password and try again.
			</div>
							...
							<div id="edit-email-expanded"
								...
								<div class="editing-email">
									<form
										...
										<p
											Style="color: black; padding-bottom: 15px; padding-top: 10px; font-size: 15px">To
											update your name, enter a different one in the fields below
